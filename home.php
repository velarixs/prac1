...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>categories</p>
         <div class="flex-box">
            <a href="category.php?category=general" class="links">general</a>
            <a href="category.php?category=news and updates" class="links">news and updates</a>
            <a href="category.php?category=builds and guides" class="links">builds and guides</a>
            <a href="category.php?category=lore and theories" class="links">lore and theories</a>
            <a href="category.php?category=rng luck" class="links">rng luck</a>
            <a href="category.php?category=fan art" class="links">fan art</a>
            <a href="category.php?category=co-op" class="links">co-op</a> 
      ...
      <div class="box">
         ...
         <div class="flex-box">
         <?php
            $select_authors = $conn->prepare("SELECT DISTINCT first_name FROM `users` LIMIT 10");
