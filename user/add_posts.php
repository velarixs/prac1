...
if(isset($_POST['publish'])){
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `posts`(user_id, first_name, title, content, category, image, status) VALUES(?,?,?,?,?,?,?)");
      $insert_post->execute([$user_id, $first_name, $title, $content, $category, $image, $status]);
...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <input type="hidden" name="first_name" value="<?= $fetch_profile['first_name']; ?>">
